...
import { getAllCourses, deleteCoursesById, getCoursesById } from "../redux/actions/admin/courssActions";
import { DeleteModel, Table } from "../Components";
import { useDispatch, useSelector } from "react-redux";
import { useNavigate, useLocation } from "react-router-dom";
import CreateModelForm from "./courses/CreateModelForm";
import EditModelForm from "./courses/EditModelForm";
              ...
              <div className="col-lg-12 mx-auto">
                <div className="forum_content">
                  ...
                  <div className="forum_table white_bg p-3">
                    ...
                    <Table
                      columns={columns}
                      data={coursesReducer?.list?.data ? coursesReducer.list.data : []}
                      actions={[
                        {
                          label: "Edit",
                ...
                <div className="course_right">
                  ...
                  <div className="white_bg p-4 box_shadow mb-3">
                    <p className="mb-2">
                      ...
                      management and leadership courses in sustainability to young
                      individuals, students, and businesses.
                    </p>
                    <p className="mb-2">
                      Our mission is to provide sustainable development support to
                      young individuals and businesses by providing them with
                      sustainability-related courses that equip them with the
                      knowledge and skills needed to develop, manage, and improve
                      sustainability in societies, enterprises, and workplaces to
                      become greener and achieve sustainable growth.
                    </p>
                    <p>
                      We currently offer two training programs for individuals and
                      businesses.
                    </p>
                  </div>
                  <div className="row">
                    <div className="col-lg-4 col-md-6">
                      <div className="courses_categories box_shadow">
                        ...
                        <div className="course_sub_text p-3">
                          ...
                          <p>
                            This program is tailored to assist businesses to become
                            greener by managing their sustainability impacts in order
                            for them to gain a competitive advantage.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="courses_categories box_shadow">
                        ...
                        <div className="course_sub_text p-3">
                          ...
                          <p>
                            ...
                            sustainability knowledge, social and green skills for their
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="courses_categories box_shadow">
                        ...
                        <div className="course_sub_text p-3">
                          ...
                          <p>
                            This course is designed to assist engineering businesses to
                            manage their engineering operations using sustainability
