...
import { createEmployee } from "../../../redux/actions/admin/employeeActions";
...
const CreateModelForm = ({ createHandleCloseModal }) => {
  ...
  return (
    <div
      className="modal fade show createEmployeeModal"
      ...
      <div className="modal-dialog">
        <div className="modal-content shadow">
          <div className="modal-header  text-white">
            <h5 className="modal-title text-white">Create Employee</h5>
            <button
              type="button"
